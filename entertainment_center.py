...
# Objects of class Movie (Title, plot, url poster, director, genre, year, vote, url imdb, url video trailer)
...
Hair = media.Movie("Hair",
                   "Claude leaves the family ranch in Oklahoma for New York where he is rapidly indoctrinated into the "
                   "outh subculture and subsequently drafted.",
                   "http://curiosando708090.altervista.org/wp-content/uploads/2012/08/hair.jpg",
                   "Milos Forman",
                   "Musical",
                   "1979",
                   "4",
...
Apollo_13 = media.Movie("Apollo 13",
                        "NASA must devise a strategy to return Apollo 13 to Earth safely after the "
                        "spacecraft undergoes massive internal damage ",
...
Pulp_Fiction = media.Movie("Pulp Fiction",
                           ...
                           "M/MV5BMjE0ODk2NjczOV5BMl5BanBnXkFtZTYwNDQ0NDg4._V1_SY317_CR4,0,214,317_AL_.jpg",
                           "Quentin Tarantino",
                           "Crime",
                           "1994",
                           "5",
...
movies = [Forrest_Gump, Hair, Apollo_13, Back_to_the_future, Pulp_Fiction, Alien]

# Call function open_movies_page from fresh_toematoes and pass the array movies
